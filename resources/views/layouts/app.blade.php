...
<head>
    ...
    {"@@context":"https://schema.org","@@type":"RealEstateAgent","name":"Acremann Properties","url":"{{ url('/') }}","description":"Trusted real estate company Kenya — clean title deeds, verified plots, diaspora-friendly land investment."}
    </script>
    @stack('head')
</head>
