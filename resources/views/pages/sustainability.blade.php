...
<x-page-hero-image
    ...
    title="Land investment for future generations"
    :lead="$settings->sustainabilityIntro()"
    heading-id="sustain-hero-heading"
    aside-label="Our commitments"
>
    <div class="page-hero-actions">
        <a href="{{ route('properties.index') }}" class="btn-primary page-hero-btn-primary">View sustainable projects</a>
        <a href="{{ route('contact') }}" class="btn-outline page-hero-btn-outline">Speak to our team</a>
    </div>

    <x-slot:aside>
        <div class="page-hero-image-card">
            <p class="page-hero-image-card-eyebrow">Our commitment</p>
            <h2 class="page-hero-image-card-title">Built into every project</h2>
            <ul class="page-hero-image-stats" role="list">
                <li class="page-hero-image-stat">
                    <span class="page-hero-image-stat-icon" aria-hidden="true">
                    ...
                    <span class="page-hero-image-stat-text">
                        <span class="page-hero-image-stat-value">Verified</span>
                        <span class="page-hero-image-stat-label">Title &amp; compliance focus</span>
                    </span>
                </li>
                <li class="page-hero-image-stat">
                    <span class="page-hero-image-stat-icon" aria-hidden="true">
                    ...
                    <span class="page-hero-image-stat-text">
                        <span class="page-hero-image-stat-value">Planned</span>
                        <span class="page-hero-image-stat-label">Green &amp; drainage design</span>
                    </span>
                </li>
                <li class="page-hero-image-stat">
                    <span class="page-hero-image-stat-icon" aria-hidden="true">
                    ...
                    <span class="page-hero-image-stat-text">
                        <span class="page-hero-image-stat-value">Documented</span>
                        <span class="page-hero-image-stat-label">Milestones to handover</span>
                    </span>
                </li>
            </ul>
        </div>
