@props(['source' => 'contact', 'property' => null])
<form action="{{ route('leads.store') }}" method="POST" class="acremann-form">
    ...
    <x-form.textarea label="Message" name="message" :rich="true" :rows="5" placeholder="Tell us about your interest, timeline, or questions…" />
